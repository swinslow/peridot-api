...
func TestShouldGetAllRepos(t *testing.T) {
	...
	mock.ExpectQuery("SELECT id, subproject_id, name, address FROM repos ORDER BY id").
...
func TestShouldGetAllReposForOneSubproject(t *testing.T) {
	...
	sentRows := sqlmock.NewRows([]string{"id", "subproject_id", "name", "address"}).
		AddRow(3, 3, "aai/aai-common", "https://gerrit.onap.org/r/aai/aai-common").
		AddRow(5, 3, "aai/esr-gui", "https://gerrit.onap.org/r/aai/esr-gui")
	mock.ExpectQuery(`SELECT id, subproject_id, name, address FROM repos WHERE subproject_id = \$1 ORDER BY id`).
		WillReturnRows(sentRows)
...
func TestShouldAddRepo(t *testing.T) {
	...
	regexStmt := `[INSERT INTO repos(subproject_id, name, address) VALUES (\$1, \$2, \$3) RETURNING id]`
	mock.ExpectPrepare(regexStmt)
	stmt := "INSERT INTO repos"
...
func TestShouldFailAddRepoWithUnknownSubprojectID(t *testing.T) {
	...
	regexStmt := `[INSERT INTO repos(project_id, name, fullname) VALUES (\$1, \$2, \$3) RETURNING id]`
	mock.ExpectPrepare(regexStmt)
	stmt := "INSERT INTO repos"
	mock.ExpectQuery(stmt).
		WithArgs(17, "unknown-subproject", "https://example.com/some-repo.git").
		WillReturnError(fmt.Errorf("pq: insert or update on table \"repos\" violates foreign key constraint \"repos_subproject_id_fkey\""))
...
func TestShouldUpdateRepoNameAndAddress(t *testing.T) {
	...
	regexStmt := `[UPDATE repos SET name = \$1, address = \$2 WHERE id = \$3]`
	mock.ExpectPrepare(regexStmt)
	stmt := "UPDATE repos"
...
func TestShouldUpdateRepoNameOnly(t *testing.T) {
	...
	regexStmt := `[UPDATE repos SET name = \$1 WHERE id = \$2]`
	mock.ExpectPrepare(regexStmt)
	stmt := "UPDATE repo"
	mock.ExpectExec(stmt).
		WithArgs("myrepo", 1).
...
func TestShouldUpdateRepoAddressOnly(t *testing.T) {
	...
	regexStmt := `[UPDATE repo SET address = \$1 WHERE id = \$2]`
	mock.ExpectPrepare(regexStmt)
	stmt := "UPDATE repo"
	mock.ExpectExec(stmt).
...
func TestShouldUpdateRepoSubprojectID(t *testing.T) {
	...
	regexStmt := `[UPDATE repos SET subproject_id = \$1 WHERE id = \$2]`
	mock.ExpectPrepare(regexStmt)
	stmt := "UPDATE repos"
	mock.ExpectExec(stmt).
		WithArgs(3, 1).
...
func TestShouldDeleteRepo(t *testing.T) {
	...
	regexStmt := `[DELETE FROM repos WHERE id = \$1]`
	mock.ExpectPrepare(regexStmt)
	stmt := "DELETE FROM repos"
	mock.ExpectExec(stmt).
		WithArgs(1).
		WillReturnResult(sqlmock.NewResult(0, 1))
