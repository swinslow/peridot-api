...
func TestShouldGetAllProjects(t *testing.T) {
	...
	mock.ExpectQuery("SELECT id, name, fullname FROM projects ORDER BY id").WillReturnRows(sentRows)
...
func TestShouldAddProject(t *testing.T) {
	...
	regexStmt := `[INSERT INTO projects(name, fullname) VALUES (\$1, \$2) RETURNING id]`
...
func TestShouldUpdateProjectNameAndFullname(t *testing.T) {
	...
	regexStmt := `[UPDATE projects SET name = \$1, fullname = \$2 WHERE id = \$3]`
	mock.ExpectPrepare(regexStmt)
...
func TestShouldUpdateProjectNameOnly(t *testing.T) {
	...
	regexStmt := `[UPDATE projects SET name = \$1 WHERE id = \$2]`
	mock.ExpectPrepare(regexStmt)
	stmt := "UPDATE projects"
	mock.ExpectExec(stmt).
		WithArgs("myprj", 1).
...
func TestShouldUpdateProjectFullnameOnly(t *testing.T) {
	...
	regexStmt := `[UPDATE projects SET fullname = \$1 WHERE id = \$2]`
	mock.ExpectPrepare(regexStmt)
	stmt := "UPDATE projects"
	mock.ExpectExec(stmt).
...
func TestShouldDeleteProject(t *testing.T) {
	...
	regexStmt := `[DELETE FROM projects WHERE id = \$1]`
	mock.ExpectPrepare(regexStmt)
	stmt := "DELETE FROM projects"
	mock.ExpectExec(stmt).
		WithArgs(1).
		WillReturnResult(sqlmock.NewResult(0, 1))
